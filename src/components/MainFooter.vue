    ...
    <div class="container">
      ...
      <div class="footer">
        <div class="footer-col">
          <h4>Contact</h4>
          <span> <strong>Address: </strong>562 Banky Road, Nigeria </span>
          <span><strong>Phone: </strong>+234-2222-365/+234-2343-563</span>
        ...
        <div class="footer-col install">
          ...
          <div class="apps">
            <a href="/home" class="download-btn">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
        ...
        <p class="copyright">
          Luxury-Store. &copy; {{ date }}. Built by Debby with
          <span>Vue.❤️</span>
        </p>
      </div>
    </div>
