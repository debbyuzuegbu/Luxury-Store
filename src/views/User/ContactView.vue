            ...
            <div class="map-details">
                ...
                <ul>
                    <li>
                        ...
                        <p>56 Folurunsho street, Lekki, Nigeria</p>
                    </li>
                    <li>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li>
                        ...
                        <p>+234-222-3654-4567/+234-234-5634-3456</p>
                    </li>
                    <li>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
            ...
            employers: [
                {
                    ...
                    phone: "+234-3054-984-5462",
                    email: "Taiwo@luxurystore.com",
                },
                {
                    image: require("@/assets/images/people/2.webp"),
                    name: "William Adeyemi",
                    position: "Senior Marketing Manager",
                    phone: "+234-305-7535-2345",
                    email: "williams@luxurystore.com",
                },
                {
                    image: require("@/assets/images/people/3.webp"),
                    name: "Debby Stone",
                    position: "Frontend Engineer",
                    phone: "+234-305-4845-2345",
                    email: "contact@luxurystore.com",
                },
            ],
        };
    },
