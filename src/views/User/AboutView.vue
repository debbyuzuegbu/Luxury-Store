<template>
    <main-header />
    <sub-header heading="About Us" subHeading="Get to know us" />
    <div class="container">
        <article>
            <img
            ...
            <div class="about-text">
                ...
                <p>
                   We are your number one stop to luxury products. We offer great customer
                    satisfaction. Our platform offers you the best goods. We are a team of
        ...
        <div class="video-section">
            <h1>Download Our <a href="/home">App</a></h1>
            <img
